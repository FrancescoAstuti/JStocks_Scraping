...
public class Quote {
    ...
    private static final String API_URL_Quote = "https://financialmodelingprep.com/api/v3/quote/";

    public static String getEPSTTM(String ticker) throws IOException {
        String urlString = API_URL_Quote + ticker + "?apikey=" + API_KEY;
        ...
        if (responseCode == 401) {
            ...
            return jsonObject.getString("eps");
        }
    }
